...
leaflet(ormgp) %>%
  ...
  addPolygons(color = ~colorQuantile("YlGn", ormgp$percov)(percov),
              popup = ~paste0('<b>sub-watershed: ',mmID,'</b>',
                              '<br>             area: ',round(Area/1000000,1),'km²',
                              '<br>     permeability: ',perm,
                              '<br> impervious cover: ',round(perimp*100,0),'%',
  ...
  addPolygons(color = ~colorQuantile("Blues", ormgp$perow)(perow),
              popup = ~paste0('<b>sub-watershed: ',mmID,'</b>',
                              '<br>             area: ',round(Area/1000000,1),'km²',
                              '<br>     permeability: ',perm,
                              '<br> impervious cover: ',round(perimp*100,0),'%',
  ...
  addPolygons(color = ~colorQuantile("GnBu", ormgp$perwl)(perwl),
              popup = ~paste0('<b>sub-watershed: ',mmID,'</b>',
                              '<br>             area: ',round(Area/1000000,1),'km²',
                              '<br>     permeability: ',perm,
                              '<br> impervious cover: ',round(perimp*100,0),'%',
  ...
  addLayersControl(
    baseGroups = c("Imperviousness", "Canopy coverage","Wetland coverage","Open water coverage"),
