...
# Map
Presented up front is the __*final*__ product for which the rest of this document describes. It is a map of the ORMGP jurisdiction discretized into 10km² sub-watersheds. *Clicking* at any sub-watershed will return a number of properties. The sub-watersheds are currently colour-coded as per their impervious coverage.
