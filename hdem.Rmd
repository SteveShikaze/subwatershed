...
One (of many) APIs (application programming interfaces) hosted by the ORMGP leverages the computed drainage topology. Users have the ability to delineate catchment area polygon for any given point that lies within the HDEM extent. Try below:
